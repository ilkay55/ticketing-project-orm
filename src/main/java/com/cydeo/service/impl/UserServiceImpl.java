...
public class UserServiceImpl implements UserService {
    ...
    public List<UserDTO> listAllUsers() {
        ...
        List<User> userList = userRepository
                .findAll(Sort.by("firstName")); //Select * from Users (where is_deleted=false)
...
//        user.setIsDeleted(true);  //deleting without checking if user has a project or task on him
//        userRepository.save(user);
    }

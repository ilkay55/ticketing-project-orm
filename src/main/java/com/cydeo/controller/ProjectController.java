...
//        model.addAttribute("projects", projectService.listAllProjects()); //To get all the projects
        model.addAttribute("projects", projectService.listAllProjectDetails()); //To get all the projects for a specific user
